 ...
 * Drop an image onto a slot to fill it; the filled slot persists via localStorage.
 *
 * Attributes:
 *   id           Persistence key. Required for persistence across reloads.
...
(() => {
  const STORE_KEY = 'kah_image_slots';
  const MAX_DIM = 1200;
      ...
      try {
        ...
        if (raw) {
          ...
          if (parsed && typeof parsed === 'object') {
            slots = Object.assign({}, parsed, slots);
          }
        }
      } catch {}
      loaded = true;
